...
public class RitsBot extends AbstractionLayerAI {
...
private void addUnitToLists(Unit unit, List<Unit>... lists) {
    ...
    public RitsBot(UnitTypeTable unitTypeTable) {
        this(unitTypeTable, new AStarPathFinding());
    }

    public RitsBot(UnitTypeTable unitTypeTable, PathFinding pf) {
        super(pf);
    ...
    @Override
    public AI clone() {
        return new RitsBot(unitTypeTable, pf);
    }
